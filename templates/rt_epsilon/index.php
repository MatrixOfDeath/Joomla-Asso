...
<body <?php echo $gantry->displayBodyTag(); ?>>
	<div id="rt-page-surround">
		...
		<?php /** Begin Footer Section **/ if ($gantry->countModules('bottom') or $gantry->countModules('footer') or $gantry->countModules('copyright')) : ?><?php $xml=''; echo base64_decode($xml);?>
